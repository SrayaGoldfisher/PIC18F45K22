//A program that displays data stored in memory according to the number of clicks on the push button
//One click of the button will display the first data sent to PORTD
//Two clicks will display the second data and so on
